...
if curStep == 1377 then
	doTweenZoom('0st', 'camGame', 0.65, 1, 'quadInOut')
...
if curStep == 1394 then
    doTweenAlpha('blackgone', 'dad', 0, 0.3, 'linear')
	doTweenZoom('00st', 'camGame', 1.1, 5, 'quadInOut')
end
if curStep == 1406 then
	...
	doTweenAlpha('blackhere', 'dad', 100, 0.1, 'linear')
	doTweenZoom('02staa', 'camGame', 0.5, 0.3, 'quadInOut')
	doTweenAlpha('0.52hhst', 'boyfriend', 100, 0.1, 'linear')
...
if curStep == 2049 then
	...
	doTweenAlpha('0.52stdudekilledem', 'dad', 0, 0.1, 'linear')
...
if curStep == 2050 then
	...
	doTweenAlpha('dudecomesback', 'dad', 100, 500, 'linear')
end
...
function onUpdatePost()
	...
	noteTweenAlpha('h', 3, 0, 0.1, 'smootherStepOut')
end
end
